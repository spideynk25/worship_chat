...
class QueenRashmikaQueendomList extends ConsumerStatefulWidget {
  const QueenRashmikaQueendomList({super.key});

  @override
  ConsumerState<QueenRashmikaQueendomList> createState() =>
      _QueenRashmikaQueendomListState();
}

class _QueenRashmikaQueendomListState
    extends ConsumerState<QueenRashmikaQueendomList>
  ...
  int _getBirthOrder(GroupModel group) {
    final nameLower = group.name.toLowerCase();
    if (nameLower.contains('first born') || nameLower.contains('firstborn'))
      return 0;
    if (nameLower.contains('second born') || nameLower.contains('secondborn'))
      return 1;
    return 2;
  }
    ...
    return StreamBuilder<List<GroupModel>>(
      ...
      builder: (context, snapshot) {
        ...
        filteredGroups.sort((a, b) {
          ...
          return _getBirthOrder(a).compareTo(_getBirthOrder(b));
        });
                  ...
                  Expanded(
                    child: filteredGroups.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            key: PageStorageKey(
                              'rashmika_list_$selectedCategoryIndex',
                            ),
...
class _QueendomGroupCard extends StatefulWidget {
  final GroupModel group;
  final Color accentColor;
  final bool hasUnseen;

  const _QueendomGroupCard({
    super.key,
    required this.group,
  ...
  @override
  State<_QueendomGroupCard> createState() => _QueendomGroupCardState();
}

class _QueendomGroupCardState extends State<_QueendomGroupCard>
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: HSLColor.fromColor(
                        color,
                      ).withLightness(0.85).withSaturation(0.6).toColor(),
